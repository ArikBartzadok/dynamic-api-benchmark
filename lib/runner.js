...
module.exports = function(options){
  ...
  this.add = function(stepName, href, stepOptions, stepRequest, opcoes, func){
    ...
    step.run = function(callback){
      ...
      for (let quantidadeJson = 0; (quantidadeJson < totalRequests); quantidadeJson++) {
        console.log('>>> gerar dados para o json', quantidadeJson);
      }
  ...
  this.runSample = function(step, next, i){
    ...
    step.func(timer, function(err, response, temporizador){
